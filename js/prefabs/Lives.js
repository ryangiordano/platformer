...
Platformer.Lives.prototype.update = function(){
  ...
  //update to show current number of lives when there is a discrepency between the lives on the player and the actual lives array.
...
Platformer.Lives.prototype.update_lives = function(){
  ...
  life = this.lives[this.lives.length -1];//because of zero index
  if(this.game_state.prefabs.player.lives < this.lives.length){
